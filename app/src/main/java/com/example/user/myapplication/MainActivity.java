...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Data[] transDate = new Data[4];
        for (int i = 0; i < transDate.length;i++){
            transDate[i] = new Data();
        }
        transDate[0].name = "腳踏車";
        transDate[1].name = "機車";
        transDate[2].name = "汽車";
        transDate[3].name = "巴士";
        transDate[0].photo=R.drawable.trans1;
        transDate[1].photo=R.drawable.trans2;
        transDate[2].photo=R.drawable.trans3;
        transDate[3].photo=R.drawable.trans4;

        myAdapter transAdapter = new myAdapter(transDate,
                R.layout.trans_list);
